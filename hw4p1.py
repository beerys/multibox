...
conf_a = Conv2D(11, (1,1), activation='softmax')(a)
...
conf_b = Conv2D(11, (1,1), activation='softmax')(b)
...
conf_c1 = Conv2D(11, (1,1),activation='softmax')(c1)
...
conf_c2 = Conv2D(11, (1,1), activation='softmax')(c2)
...
conf_c3 = Conv2D(11, (1,1), activation='softmax')(c3)
